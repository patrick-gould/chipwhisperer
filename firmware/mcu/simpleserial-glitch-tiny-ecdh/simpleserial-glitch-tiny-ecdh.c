/**
    ...
    This file, adapted from tiny-ecdh, contains a simple and small version of ecdh.
...
/// @brief Runs code under test.
/// @param  zero constant zero. Used to trick teh compiler to not remove an impossible if-condition.
...
// Code and comments below are from tiny-ecdh.
/*
